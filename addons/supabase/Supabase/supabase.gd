...
var config : Dictionary = {
	"supabaseUrl": "https://pfihnlhgestcjnqqdxch.supabase.co",
	"supabaseKey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBmaWhubGhnZXN0Y2pucXFkeGNoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQzMjUyNTksImV4cCI6MjA1OTkwMTI1OX0.6UWexKYbGBRbenRTadIiA1J7_wEsVjHccIxlL6u01Z8"
}
