...
func _ready():
	...
	f1 = Function.new(
		x, y, "Dinero Actual", # This will create a function with x and y values taken by the Arrays 
	...
	f2 = Function.new(x, y2, "Error", { color = Color("#ff6384"), marker = Function.Marker.CROSS })
	f3 = Function.new(x, y3, "Ventas", { color = Color.GREEN, marker = Function.Marker.CIRCLE })
