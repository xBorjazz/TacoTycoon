...
#
#	await get_tree().create_timer(1.0).timeout	# Mover por 3 segundos con la animación walk_left_down
#	left_down_anim()
...
#	$PlayerAnimation.play("buying")  # Reproduce la buying
#
## Función que reanuda el movimiento del personaje
#func left_down_anim() -> void:
#	stopped = false
#	speed = 3.5  # Restaura la velocidad original
#	direction = directionld
#	$PlayerAnimation.play("walk_left_down")  # Reanuda la animación de caminar hacia la izquierda-abajo
#
...
#		$PlayerAnimation.play(chosen_animation["name"])
...
#		$PlayerAnimation.play("walk_right_up")
#		print("Tercera Condición")
#
#func fade_out_anim() -> void:
#		$PlayerAnimation.play("fade_out")  # Inicia la animación de desvanecimiento
